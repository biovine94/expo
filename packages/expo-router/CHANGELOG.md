...
- Remove `createStackNavigator` from `expo-router/js-stack`. Use `createStandardStackNavigator` with `unstable_integrateWithRouter` instead. Migrate Slot, JavaScript Stack, and ExperimentalStack to the `standard-navigation` integration. ([#49209](https://github.com/expo/expo/pull/49209) by [@Ubax](https://github.com/Ubax))
